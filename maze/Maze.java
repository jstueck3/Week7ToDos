...
public class Maze {
    private static edu.wctc.maze.Room currentRoom;

    private edu.wctc.maze.Player player = new edu.wctc.maze.Player();

    /*
     * Maze receives its starting room from the construction strategy
     * in the Main class.
     */
    public Maze(edu.wctc.maze.Room startingRoom) {
    ...
    public void performAction(char action) {
        switch (action) {
            ...
            case 'n':
                ...
                } catch (edu.wctc.maze.NoAdjoiningRoomException e) {
            ...
            case 'v':
                ...
                //print the Queue
                System.out.println("Get Inventory" + new edu.wctc.maze.Player());
            ...
            default:
                ...
                // 'i' interact
                try {
                    currentRoom.performAction(action,
                            player);
                } catch (edu.wctc.maze.InvalidActionException e) {
